...
@torch.no_grad()
def compute_bernstein_landing_probility(
    ...
    deg_sqrt_v = deg.pow(-0.5).view((-1, 1))
    deg_sqrt_h = deg.pow(0.5).view((1, -1))
    basis = [deg_sqrt_v * base * deg_sqrt_h for base in basis]
